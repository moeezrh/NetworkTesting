...
def main():
    ...
    for each_file in os.listdir(temp_path):
        ...
        # CHECKs if it was ever disconnected, and changes message to FAIL (WAS DISCONNECTED)
         ...
         check_final_start = output.find("FINAL STATUS: ")
         check_final_end = output.find("END FINAL STATUS")
         final = output[check_final_start + 13: check_final_end]

         if final.find("DISCONNECTED") != -1:
...
def ping (host, packets):
     ...
     with open(temp_file_name, "a") as file:   
          ...
          time_elapsed += "FINAL STATUS: " + state_before + " END FINAL STATUS"
